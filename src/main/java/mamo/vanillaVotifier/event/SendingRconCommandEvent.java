...
public class SendingRconCommandEvent implements CommandEvent, RconEvent {
	@NotNull protected RconConnection rconConnection;
	@NotNull protected String command;

	public SendingRconCommandEvent(@NotNull RconConnection rconConnection, @NotNull String command) {
